...
import com.micronautbook.data.repositories.GrailsBookCrudRepository;
import com.micronautbook.data.repositories.MicronautBookCrudRepository;
...
class BookControllerTest {
    ...
    @Inject
    MicronautBookCrudRepository micronautBookRepository;

    @Inject
    GrailsBookCrudRepository grailsBookRepository;
    ...
    void books() {
        ...
        //when:
        List<Book> books = client.retrieve(HttpRequest.GET("/books/micronaut"), arg);
        //then:
        ...
        //when:
        books = client.retrieve(HttpRequest.GET("/books"), arg);
        //then:
